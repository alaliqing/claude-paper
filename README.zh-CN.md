...
### 自适应学习材料
根据论文复杂性生成综合学习资源：
- **核心材料**（始终包含）：README、摘要、洞察力和渐进式问答（15 个问题）
- **自适应材料**（按需生成）：复杂论文的 method.md、分类的 mental-model.md、扩展的 reflection.md

### 代码演示
- **可运行演示** - 清晰、注释完整的实现
- **Jupyter 笔记本** - 用于交互式学习的 .ipynb 文件
- **原始代码集成** - 自动克隆并包含论文的 GitHub 代码（如有）

### 网页查看器
- **Nuxt.js 驱动界面** - 现代响应式网页应用，地址为 http://localhost:5815
- **数学公式渲染** - KaTeX 支持数学方程
- **论文卡片** - 带元数据和代码链接的视觉概览
...
Claude Paper 使用智能**自适应生成系统**，根据论文复杂性创建材料：
...
### 内容自适应
- **简单论文** → 仅核心材料（README、摘要、洞察力、问答）
- **复杂方法论** → + method.md 详细说明
- **新颖框架** → + mental-model.md 定位
- **突破性工作** → + reflection.md 扩展
